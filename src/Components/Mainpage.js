...
import {abi, CA} from '../Functions.js'
...
async function totalSupply() {
  ...
  return (
    <div className='Main-Container'>
        <div className='title'>
        <h1>Void Feathers Minting dApp</h1>
        </div>
        ...
        <div className='main-box'>
            ...
            <div className='box2'>
                <div className='middle'>
                  ...
                  {walletAddress.length > 0 ? ` ${walletAddress.substring(0)}.... ${walletAddress.substring(100)}` : ""}
                  </small></div>  <br />
               <div className='split'>
               <button> <p>  
             ...
             <div className='split'>
             <button id='m' onClick={() => increment()} className='button, button1'><h1 style={{color: 'black'}}>+</h1></button> 
             <p>Mint: {count}</p>
             <button onClick={() => decrement()} className='button, button1'><h1 style={{color: 'black'}}>-</h1></button>
             </div> <br />
             <button onClick={mintNft} className='btn1'>Mint</button>
            </div>
      <div className='box1'>
